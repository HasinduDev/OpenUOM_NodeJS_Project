...
app.post("/api/customer/register", (req, res, next) => {
    ...
    try {
        ...
        if (creditCardRegExp.test(cardNumber)!=true) {
        ...
        var params = [name,address,email,dateOfBirth,gender,age,cardHolderNames,cardNumber,expiryDate,cvv,timeStamp]
